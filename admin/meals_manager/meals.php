...
$sql = "SELECT * FROM ".$db_suffix."meals";
...
<!-----PAGE LEVEL CSS END--->
            ...
            <div class="col-md-12">
               ...
               <div class="portlet box grey-cascade">
                  <div class="portlet-title">
                     <div class="caption"><i class="fa fa-table"></i>Mealtyps</div>
                     <div class="actions">
                        <a href="<?php echo SITE_URL_ADMIN.'?mKey='.$mKey.'&pKey=addmeals'; ?>" class="btn blue"><i class="fa fa-plus"></i> Mealtyp einfügen</a>
                        <div class="btn-group">
		   ...
		   ?>
                           ...
                           <tr class="odd gradeX">
                            ...
                            <td><?php echo $row->meals_creation_time;?></td>
                              <!--<td>
                              
                              <a href="<?php echo '?mKey='.$mKey.'&pKey=editmeals&id='.$row->meals_ID;?>" class="btn default btn-xs purple"><i class="fa fa-edit"></i> Edit</a>
   ...
   <script src="<?php echo SITE_URL_ADMIN; ?>assets/admin/pages/scripts/table-managed.js"></script>
    ...
    <script>
                jQuery(document).ready(function() {    
                 ...
                 var table_name='meals';
					 
                 var column_name='meals_status';

                 var column_id='meals_ID';
