...
$journey_ID = isset($_REQUEST['id']) ? $_REQUEST['id']: 0;
$sql = "select * from ".$db_suffix."journey where journey_ID = $journey_ID limit 1";				
...
if(mysqli_num_rows($query) > 0)
{
    ...
    $journey_status    = $content->journey_status;
    $journey_notes    = $content->journey_notes;
    $journey_update_time    = $content->journey_update_time;
}
...
{	
	...
	if($err == 0)
	{
		$sql = "UPDATE ".$db_suffix."journey SET locations_ID='$locations_ID',journey_title='$journey_title',journey_price='$journey_price',journey_status='$journey_status',journey_notes='$journey_notes' WHERE journey_ID=$journey_ID";
...
<!-----PAGE LEVEL CSS END--->
                                        ...
                                        <ul class="page-breadcrumb">
                                                ...
                                                <li>
                                                        <a href="<?php echo SITE_URL_ADMIN.'?mKey=journey&pKey=journey'; ?>">Reisetyp Liste</a>
														<i class="fa fa-angle-right"></i>
                                                </li>
												<li>
                                                        <a  href="#">Reisetyp ID: <?php echo $journey_ID; ?></a>
                                                </li>
                                        </ul>
                          ...
                          <div class="alert alert-<?php echo $alert_type; ?> <?php echo $alert_box_show; ?>">
                            ...
                            <?php echo $alert_message; ?>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-md-2">
                                      <input type="text" class="form-control" disabled value="<?php echo $journey_update_time;?>" />
                                  </div>
                              </div>         
