...
$sql = "SELECT * FROM ".$db_suffix."bookings ORDER BY bookings_ID DESC";
...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="<?php echo SITE_URL_ADMIN.'?mKey='.$mKey.'&pKey='.$pKey; ?>">
                <?php echo $menus["$mKey"]["$pKey"]; ?>
            </a>
        </li>
    </ul>
    ...
    <div class="col-md-12">
        ...
        <div class="portlet box grey-cascade">
            <div class="portlet-title">
                <div class="caption"><i class="fa fa-table"></i>Buchungen</div>
                <div class="actions">
                    <div class="btn-group">
		   ...
		   ?>
                        ...
                        <tr class="odd gradeX">
                            <td><input type="checkbox" class="checkboxes" value="<?php echo $row->bookings_ID;?>" /></td>
                            <td><a href="<?php echo '?mKey='.$mKey.'&pKey=editbookings&id='.$row->bookings_ID;?>"><?php echo $row->bookings_code;?></a></td>

                            <td>
                                <?php echo $row->bookings_notes;?>
                            </td>
                            <td>
                            ...
                            <td>
                                <?php echo $row->bookings_check_in_date;?>
                            </td>
                            <td>
                                <?php echo $row->bookings_check_out_date;?>
                            </td>
                            <td>
                                <?php if($row->bookings_status)
                            ...
                            <td>
                                <?php echo $row->bookings_creation_time;?>
                            </td>
                            <!--<td>

                                <a href="<?php echo '?mKey='.$mKey.'&pKey=travelers&id='.$row->bookings_ID;?>" class="btn default btn-xs purple"><i class="fa fa-plane"></i> Reisender</a>
...
<script>
    ...
    var column_name = 'bookings_status';

    var column_id = 'bookings_ID';
