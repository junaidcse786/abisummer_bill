...
{	
	...
	if($err == 0)
	{
		$sql = "INSERT INTO ".$db_suffix."journey_location SET jl_city_location='$jl_city_location',jl_price='$jl_price',jl_status='$jl_status',jl_notes='$jl_notes', journey_ID='$journey_ID'";
...
<!-- BEGIN PAGE jl_city_location & BREADCRUMB-->
<h3 class="page-jl_city_location">
    Abfahrtsort einfügen
</h3>
<div class="page-bar">
    ...
    <!-- END PAGE jl_city_location & BREADCRUMB-->
</div>
<!-- END PAGE HEADER-->
                ...
                <div class="form-body">
                    ...
                    <form action="<?php echo str_replace('&s_factor=1', '', $_SERVER['REQUEST_URI']);?>" class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group <?php echo $messages[" jl_price "]["status "] ?>">
                            <label class="control-label col-md-3" for="jl_price">Gesammtpreis von diesem Ort <span class="required">*</span></label>
                            <div class="col-md-4">
                                <input type="number" step="any" placeholder="" class="form-control" name="jl_price" value="<?php echo $jl_price;?>" />
