...
$sql = "SELECT * FROM ".$db_suffix."rooms";
...
<!-----PAGE LEVEL CSS END--->
            ...
            <div class="col-md-12">
               ...
               <div class="portlet box grey-cascade">
                  <div class="portlet-title">
                     <div class="caption"><i class="fa fa-table"></i>Zimmertyp</div>
                     <div class="actions">
                        <a href="<?php echo SITE_URL_ADMIN.'?mKey='.$mKey.'&pKey=addrooms'; ?>" class="btn blue"><i class="fa fa-plus"></i> Zimmertyp einfügen</a>
                        <div class="btn-group">
		   ...
		   ?>
                           ...
                           <tr class="odd gradeX">
                              <td><input type="checkbox" class="checkboxes" value="<?php echo $row->rooms_ID;?>" /></td>
                            ...
                            <td><?php echo $row->rooms_creation_time;?></td>
                           </tr>
   ...
   <script src="<?php echo SITE_URL_ADMIN; ?>assets/admin/pages/scripts/table-managed.js"></script>
    ...
    <script>
                jQuery(document).ready(function() {    
                 ...
                 var column_name='rooms_status';

                 var column_id='rooms_ID';
